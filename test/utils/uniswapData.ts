...
import { MixedRouteTrade, MixedRouteSDK, Trade as RouterTrade } from '@xswap-v3/router-sdk'
import { Trade as V2Trade, Pair, Route as RouteV2, computePairAddress } from '@xswap-v3/v2-sdk'
import {
  Trade as V3Trade,
  Pool,
  Route as RouteV3,
